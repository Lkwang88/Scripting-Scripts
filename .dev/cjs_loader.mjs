...
// 用法：qjs cjs_loader.js   （入口硬编码为 test.js）
// ═══════════════════════════════════════════════════════════════
import * as std from "std";
import * as os from "os";

// ---- node 环境 shim（quickjs 的 std.out 是缓冲的，必须 flush）----
...
// ---- 入口：loader 同目录下的 test.js（qjs cjs_loader.js）----
const selfPath = std.scriptArgs[0];
